...
public class ClassifyOne {
     ...
     * 二级分类
     */
    private List<ClassifyTwo> twoClassifyList;
    /**
     * 分类ID
     */
    ...
    public List<ClassifyTwo> getTwoClassifyList() {
        return this.twoClassifyList;
    }

    public void setTwoClassifyList(final List<ClassifyTwo> twoClassifyList) {
