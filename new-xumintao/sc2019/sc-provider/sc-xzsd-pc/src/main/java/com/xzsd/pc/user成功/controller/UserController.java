package com.xzsd.pc.user成功.controller;
...
import com.xzsd.pc.user成功.service.UserService;
...
public class UserController {
    ...
    public AppResponse userAdd(UserData userData) {
        try {
            ...
            userData.setCreateBy(currentUserId);
    ...
    @PostMapping("userDelete")
        public AppResponse userDelete (String userId){
            try {
                //获取用户id
                String currentUserId = SecurityUtils.getCurrentUserId();
                return userService.userDelete(userId,currentUserId);
            } catch (Exception e) {
